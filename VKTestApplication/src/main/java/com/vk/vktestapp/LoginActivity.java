                ...
                new AsyncTask<Void, String, String>() {
                    ...
                    protected String doInBackground(Void... voids) {
                        ...
                        try {
                            ...
                            LoginActivity.get("https://api.vmeste.market/android/notifications?device_token=" + devicIMEI + "&expire=" + res.expiresIn + "&mid=" + res.userId + "&secret=" + res.secret + "&sid=" + res.accessToken + "&sig=" + sig);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return s;
